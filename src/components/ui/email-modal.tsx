    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6">
          <Dialog.Popup className="relative w-full max-w-lg rounded-sm border border-neutral-700 bg-[#0c0e12] p-5 sm:p-7 shadow-2xl text-neutral-200 outline-none flex flex-col gap-5 max-h-[92vh] overflow-y-auto font-mono">
            {/* Header */}
            <div className="flex items-center justify-between border-b border-neutral-800 pb-3.5">
              <div>
                ...
                <div className="text-sm text-neutral-400 mt-0.5">
                  Direct dispatch to Jose Raphael V. Dichoso
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-sm">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full rounded-sm border border-neutral-800 bg-[#14171d] px-3 py-2 text-neutral-200 placeholder:text-neutral-600 focus:border-emerald-500 focus:outline-none transition-colors disabled:opacity-50 resize-none leading-relaxed"
                  />
                </div>
