...
export function Skills() {
  ...
  return (
    <section id="skills" className="w-full border-b border-neutral-800/80 bg-[#090a0c] py-10 sm:py-16 lg:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-8 space-y-10 font-mono">
        ...
        <div className="rounded-sm border border-neutral-800 bg-[#0f1115] p-4 sm:p-6 lg:p-7 divide-y divide-neutral-800/70">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
                {category.skills.map((skill) => (
                  <span
                    key={skill}
                    className="rounded-sm border border-neutral-800 bg-neutral-900 px-2 py-0.5 sm:px-2.5 sm:py-1 text-xs sm:text-sm text-neutral-300 hover:border-neutral-700 hover:text-white transition-colors"
                  >
                    {skill}
                  </span>
                ))}
